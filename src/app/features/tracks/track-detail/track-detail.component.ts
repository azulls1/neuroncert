        ...
        @if (activeTab() === 'theory') {
          <div class="tab-panel animate-fadeInUp">
            <div class="alert alert-info">
              ...
              <div class="alert__content">
                <span class="alert__title"
                  >Estudia los conceptos clave antes de tomar el examen</span
                >
              </div>
            </div>
            <div style="display: flex; gap: 12px; margin-top: 16px; flex-wrap: wrap;">
              ...
              >
              <a class="btn btn-secondary" [routerLink]="['/study/review', t.id]"
        ...
        @if (activeTab() === 'practice') {
          <div class="tab-panel animate-fadeInUp">
            ...
            <div style="display: flex; gap: 12px; flex-wrap: wrap;">
              ...
              <a class="btn btn-ghost" [routerLink]="['/study/review', t.id]"
                >Repaso de Conceptos</a
              >
            </div>
          </div>
