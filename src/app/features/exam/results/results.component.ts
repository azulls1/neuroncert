  ...
  template: `
    <div class="page-medium animate-fadeInUp stagger-children">
      ...
      <div class="page-header text-center animate-fadeInUp">
        <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-forest text-white mb-4">
          <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
          </svg>
        </div>
        <h1 class="page-header__title font-display text-3xl">
          ¡Examen Completado!
        </h1>
      ...
      <div class="card-section mb-6 animate-fadeInUp">
        <h2 class="font-display text-xl font-bold text-forest text-center mb-6">Resultados del Examen</h2>
        ...
        <div class="flex justify-center mb-8 animate-scaleIn">
          <div class="card-stat text-center px-12 py-8 shadow-forest-lg">
            ...
            <div class="card-stat__value font-display text-5xl text-forest">{{ examResult()?.score }}%</div>
        ...
        <div class="mb-6 animate-fadeInUp">
          <div class="progress-labeled">
            <div class="progress progress--lg" [ngClass]="{
              'progress--success': examResult() && examResult()!.score >= 70,
              'progress--warning': examResult() && examResult()!.score >= 50 && examResult()!.score < 70,
        ...
        <div class="alert animate-fadeInUp" [ngClass]="{
      ...
      <!-- Acciones -->
      <div class="flex-row justify-center animate-fadeInUp" style="flex-wrap: wrap; justify-content: center;">
        <button
          type="button"
          (click)="startNewExam()"
